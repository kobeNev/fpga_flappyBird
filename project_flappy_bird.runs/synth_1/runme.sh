...
HD_PWD='C:/project_flappy_bird/project_flappy_bird.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_VGA_pacman.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_VGA_pacman.tcl
