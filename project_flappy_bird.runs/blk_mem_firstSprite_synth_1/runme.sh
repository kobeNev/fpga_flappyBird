...
HD_PWD='C:/project_flappy_bird/project_flappy_bird.runs/blk_mem_firstSprite_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_firstSprite.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_mem_firstSprite.tcl
