...
HD_PWD='C:/project_flappy_bird/project_flappy_bird.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_VGA_pacman.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_VGA_pacman.tcl -notrace
